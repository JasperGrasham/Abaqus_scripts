...
holeModel.parts['Holepart2'].seedEdgeByNumber(edges=edge_in_circle1, number=8, constraint=FINER)
holeModel.parts['Holepart2'].seedEdgeByNumber(edges=edge_in_circle2, number=8, constraint=FINER)
holeModel.parts['Holepart2'].seedEdgeByNumber(edges=edge_in_circle3, number=8, constraint=FINER)
holeModel.parts['Holepart2'].seedEdgeByNumber(edges=edge_in_circle4, number=8, constraint=FINER)
holeModel.parts['Holepart'].seedEdgeByNumber(edges=edge_in_circle5, number=8, constraint=FINER)
holeModel.parts['Holepart'].seedEdgeByNumber(edges=edge_in_circle6, number=8, constraint=FINER)

holeModel.parts['Holepart2'].seedEdgeByBias(biasMethod=SINGLE, end2Edges=edge_in_square1, ratio=5.0, number=8, constraint=FINER)
holeModel.parts['Holepart2'].seedEdgeByBias(biasMethod=SINGLE, end2Edges=edge_in_square2, ratio=5.0, number=8, constraint=FINER)
holeModel.parts['Holepart2'].seedEdgeByBias(biasMethod=SINGLE, end1Edges=edge_in_square3, ratio=5.0, number=8, constraint=FINER)

holeModel.parts['Holepart'].seedPart(size=0.003,  deviationFactor=0.1)
holeModel.parts['Holepart2'].seedPart(size=0.003,  deviationFactor=0.1)
