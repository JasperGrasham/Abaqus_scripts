...
side1Edges1 = holeInstance.edges.getSequenceFromMask(mask=('[#30000 ]',), )
...
edges1 = holeInstance.edges.getSequenceFromMask(mask=('[#30000 ]',), )
...
faces_ambient = holeInstance.faces.getSequenceFromMask(mask=('[#7f ]',), )
edges_ambient = holeInstance.edges.getSequenceFromMask(mask=('[#fffff ]',), )
verts_ambient = holeInstance.vertices.getSequenceFromMask(mask=('[#3fff ]',), )
...
mesh_elem_type = mesh.ElemType(elemCode=DC2D4, elemLibrary=STANDARD)
...
holePart.seedEdgeByBias(biasMethod=SINGLE, end2Edges=edge_in_square1, ratio=5.0, number=80, constraint=FINER)
holePart.seedEdgeByBias(biasMethod=SINGLE, end2Edges=edge_in_square2, ratio=5.0, number=80, constraint=FINER)
holePart.seedEdgeByBias(biasMethod=SINGLE, end1Edges=edge_in_square3, ratio=5.0, number=80, constraint=FINER)
