...
bearing_face_point = (0.5, 20.0, 0.5)
bearing_face = bearingInstance.faces.findAt((bearing_face_point,))

bearingface_region = regionToolset.Region(side1Faces=bearing_face)

bearingModel.Pressure(name='Load', createStepName='Load Step', region=bearingface_region, distributionType=UNIFORM,
...
bearingPart.seedPart(size=0.25, deviationFactor=0.01)
